                  ...
                  child: MaterialButton(
                    onPressed: ()async{
                      ...
                      try{
                        ...
                        Navigator.pushReplacementNamed(context, ChatScreen.id);   //!pushReplacementNamed digunakan ketika kita ingin berganti screen kemudia screen yang sebelumnya di hapus
                        setState(() {
                          showSpinner = false;
                        });
                      }
